...
<head>
    ...
    <!-- Website Title -->
    <title>Digital Spinning Tops</title>
	...
	<!-- Favicon  -->
    <link rel="gif" href="images/logo.gif">
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#header">Twitter</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#features">Instagram</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#details">Telegram</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#pricing">Discord</a>
                    </li>
                </ul>
                <span class="nav-item">
                    <a class="btn-outline-sm" href="https://opensea.io/collection/digital-spinning-tops">Opensea.io</a>
                </span>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>Digital Spinning Tops</h1>
                            <p class="p-large">Digital Spinning Tops is home to 10,000 generative 3D arts about top</p>
                            <a class="btn-solid-lg page-scroll" href="https://opensea.io/collection/digital-spinning-tops">Opensea.io</a>
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="images/1005.jpeg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">PHASE III</h4>
